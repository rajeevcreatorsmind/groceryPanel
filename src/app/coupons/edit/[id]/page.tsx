...
import { Plus, ArrowLeft, Calendar, Users, IndianRupee, Percent, Clock, CheckCircle2, Loader2, AlertCircle, Copy } from '@/components/icons';
...
export default function EditCouponPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.couponCode.trim()) { setError('Coupon code is required'); setIsSaving(false); return; }
    if (!formData.discountValue || Number(formData.discountValue) <= 0) { setError('Valid discount value is required'); setIsSaving(false); return; }
    if (!formData.maxUses || Number(formData.maxUses) <= 0) { setError('Maximum uses must be at least 1'); setIsSaving(false); return; }
    if (!formData.expiryDate) { setError('Expiry date is required'); setIsSaving(false); return; }
        ...
        <div className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-1">Update the details for this discount</p>
            </div>
            ...
            {success && (
              <div className="mb-6 bg-green-50 border border-green-200 text-green-800 px-5 py-4 rounded-xl flex items-center gap-3 shadow-sm">
                ...
                <div>
                  <p className="font-semibold">Coupon updated successfully!</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-7">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        type="button"
                        onClick={() => navigator.clipboard.writeText(formData.couponCode)}
